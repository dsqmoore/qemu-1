...
static int  goldfish_mmc_bdrv_read(GoldfishMMCDevice *s,
...
static int  goldfish_mmc_bdrv_write(GoldfishMMCDevice *s,
                                    int64_t                    sector_number,
                                    target_phys_addr_t         dst_address,
                                    int                        num_sectors)
{
...
static void goldfish_mmc_do_command(GoldfishMMCDevice *s, uint32_t cmd, uint32_t arg)
{
...
{
    uint32_t ret;
    GoldfishMMCDevice *s = (GoldfishMMCDevice *)opaque;
